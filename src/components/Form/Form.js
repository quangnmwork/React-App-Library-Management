    ...
    return(
        <div className = {styles.divform }>
            <form className = {styles.form}>
                ...
                <input type="text" id="fname"  placeholder="Book name.." ref={bookName}/>
                ...
                <input type="text" id="available"  placeholder="Number books.." ref = {availale}/>

                <label htmlFor="category">Category</label>
                <input type="text" id="category"  placeholder="Category.." ref ={category}/>

                <label htmlFor="descript">Description</label>
                <textarea type="text" id="descript" className  placeholder="Description.." ref ={descript}/>
